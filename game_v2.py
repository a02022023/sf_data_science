...
def score_game(predict_func) -> int:
    """Измерим качество переданной "угадывательной функции" predict_func:
    загадаем 1000 случайных чисел от 1 до 100 включительно, 
    угадаем их все с помощью predict_func, 
